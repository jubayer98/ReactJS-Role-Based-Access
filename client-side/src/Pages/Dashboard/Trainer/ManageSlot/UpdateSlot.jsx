...
const UpdateSlot = () => {
    ...
    const [slotsDuration, setSlotsDuration] = useState(null);
                ...
                try {
                    ...
                    if (response.data) {
                        ...
                        if (matchedUser) {
                            ...
                            setSlotsDuration(matchedUser.slot_duration)
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="p-4 max-w-lg mx-auto bg-white rounded-lg shadow">
            <h2 className="text-lg font-semibold text-emerald-500 mb-4">Update Slot</h2>
            ...
            <div className="mb-4">
                ...
                type="number" 
                id="slot_duration" 
                {...register('slot_duration', { required: true })}
                defaultValue={slotsDuration} 
